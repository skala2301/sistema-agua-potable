...
class System_status extends CI_Model implements CoreInterface
{
    ...
    public function _render($params = NULL)
    {
         ...
         $gaversion                 = $this->config->item("garrobo_version");

         $memory                    = memory_convert(memory_get_usage(true));
         $max_memory                = memory_convert( memory_get_peak_usage());
         $ci                        = CI_VERSION;
