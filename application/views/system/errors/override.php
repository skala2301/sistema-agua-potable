...
<div class="page-inner">
    <img src="<?php echo $route; ?>images/error/earth.jpg" class="img-responsive" alt="">
</div>
<!--FINAL DIV IMAGEN DE FONDO-->
...
<div class="container error-404">
    ...
    <p>
        El sistema no puede continuar debido a que no se encuentra el archivo de configuracion.
    </p>
    <p>
